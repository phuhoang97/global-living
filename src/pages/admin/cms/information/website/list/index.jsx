...
import { AdminWebsiteServices } from "../service/index";
import { columnsWebsite } from "./columns";

const AdminWebsiteContact = () => {
        ...
        setDataSource(
          mapData(
            response.common_data.filter(
              (item) => item.type === 3 && item.type_detail === 5
            )
          )
        );
        setLoading(false);
...
export default AdminWebsiteContact;
