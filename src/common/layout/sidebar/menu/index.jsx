              ...
              <div className="flex items-center justify-between">
                ...
                <Dropdown
                  menu={{
                    ...
                    onClick: (e) => onClickMenuCategory(e, item?.id),
                  }}
                  trigger={["click"]}
                >
                  <MoreOutlined />
  ...
  const items = [
    getItem(
      ...
      [
        ...
        getItem(
          ...
          <InfoCircleOutlined />,
          [
            getItem("Hot line", "/admin/information/hotline"),
            getItem("Email", "/admin/information/email"),
            getItem("Website", "/admin/information/website"),
          ]
        ),
    ...
    getItem(
      ...
      [
        ...
        getItem("Tổng quan", "/admin/cms/realState", <FileTextOutlined />),
        getItem(
          "Định vị thương hiệu",
