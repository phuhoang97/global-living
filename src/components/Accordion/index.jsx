...
export default function Accordion({ keySelect }) {
	...
	const accordionData = [
		{
			...
			answer: "Thẻ cư trú - còn gọi là thẻ RP (RESIDENCE PERMIT) Hungary sẽ được cấp trong khoảng 3-4 tháng.",
			group: "card",
		},
		{
			question:
				"Thẻ cư trú - Residence Permit (RP) có thời hạn bao nhiêu năm và chi phí gia hạn là bao nhiêu?",
			answer: "Thời hạn của thẻ RP là 3 năm và sau 3 năm sẽ gia hạn thẻ nếu vẫn duy trì bất động sản. Chi phí gia hạn cho 1 hộ gia đình (gồm đương đơn chính, vợ/chồng và các con dưới 18 tuổi) hiện là 5.000 EUR.",
			group: "card",
		},
		{
			question:
			...
			answer: "Có thể. Tuy nhiên, khi thẻ sắp hết hạn cần nộp hồ sơ xin gia hạn thẻ thì giá trị BĐS vẫn phải đảm bảo theo yêu cầu. Có thể vẫn giữ BĐS có giá trị thấp hơn này và mua chung với người khác thêm BĐS nữa để đảm bảo giá trị BĐS tối thiểu theo quy định.",
			group: "card",
		},
		{
			question:
      ...
      * Vì thế tổng thời gian tối thiểu để làm thẻ & mua BĐS có thể là dưới 3 tháng & tối đa là 6 tháng. `,
        ...
        * Tuy nhiên nếu NĐT kinh doanh từ BĐS đang đầu tư tại nước đó, thì phải thực hiện nghĩa vụ thuế theo quy định.`,
		...
		},
		{
			...
			answer: "* Được chuyển nhượng hoặc trao tặng cho con, khi chuyển nhượng gia đình không cần phải sang Hungary. Tất cả thủ tục có thể uỷ quyền thông qua luật sư làm.",
			group: "rule",
		},
		{
			question:
			...
			answer: "* Nếu sang nước khác làm việc thì phải nộp thuế theo quy định của nước sở tại. Nếu ở Hungary thì đương đơn không được đi làm thuê (bởi người đứng đơn nguyên tắc đang là chủ đầu tư), chỉ có thể làm chủ như mở nhà hàng, mở kinh doanh buôn bán… (nộp thuế theo quy định từng ngành nghề…), các thành viên khác thì có thể đi làm.",
			group: "rule",
		},
		{
			question: "Học phí các cấp học tại Hungary là bao nhiêu? ",
			answer: "* Miễn phí với các trường công lập từ mẫu giáo đến hết cấp 3. Chỉ cần đóng học phí tại các trường quốc tế và mức học phí cũng chỉ tương đương các trường quốc tế ở Việt Nam.",
			group: "education",
		},
		{
			question:
		...
		{
			question:
				"Mức lợi nhuận từ việc kinh doanh/ cho thuê BĐS là bao nhiêu? ",
	...
	return (
		<Div className="cs-accordians cs-style1">
			{accordionData
				?.filter((item) => item?.group === keySelect)
				.map((item, index) => (
					<Div
